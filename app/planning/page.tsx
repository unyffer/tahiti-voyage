...
function getSlug(lieu: string) {
  return lieu.toLowerCase().replace(' ', '-')
}
              ...
              <div key={etape.id} className="relative flex gap-4">
                ...
                >
                  <div className="flex items-start justify-between gap-2 flex-wrap">
                    <div>
                      {lienIle ? (
                        <Link href={lienIle} className="text-lg font-bold text-teal-700 hover:text-teal-800">
                          {etape.lieu}
                        </Link>
                      ) : (
                  ...
                  {lienIle && (
                    <Link href={lienIle} className="text-sm text-teal-600 hover:text-teal-700 font-medium mt-2 inline-block">
